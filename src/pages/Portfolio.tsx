        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-platinum-300 mb-6 leading-relaxed">
              ...
              platform for children. It features alphabets, numbers, colors,
              shapes, animals, fruits, vegetables, moral stories, rhymes,
              memory games, puzzles, and quizzes — making learning playful,
              engaging, and fun.
            </p>
          ...
          >
            ...
            <a
              href="https://gayathri-s-portfolio.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-full block py-3 border border-electric-400 text-electric-300 hover:bg-electric-400 hover:text-background transition-all duration-300 glow-electric-hover text-center"
            >
          ...
          {/* MR Farmland Advisories Website */}
          <div
            className="group animate-fade-in-up bg-gradient-to-br from-platinum-900/50 to-background border border-platinum-800 p-8 hover:border-electric-400/20 transition-all duration-500 hover:scale-105 hover:glow-electric"
          ...
          >
            ...
            <p className="text-platinum-300 mb-6 leading-relaxed">
              A web platform designed to provide farmland advisory services,
              offering insights on crop planning, soil health, and sustainable
              farming practices. Built with modern web technologies for
              scalability and ease of use.
            </p>

            <div className="mb-6">
              <div className="flex flex-wrap gap-2">
                {["React", "Tailwind CSS", "Vercel"].map((tech, i) => (
                  <span
                    key={i}
                    className="px-4 py-2 bg-electric-500/10 text-electric-300 text-sm border border-electric-500/20 rounded-md"
                  >
            ...
            <a
              href="https://mr-farmland-website.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-full block py-3 border border-electric-400 text-electric-300 hover:bg-electric-400 hover:text-background transition-all duration-300 glow-electric-hover text-center"
            >
